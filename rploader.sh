...
function getredpillko() {
    ...
    if [ $MODEL == "FS2500" ]; then
        ...
        echo "Downloading peter's ${ORIGIN_PLATFORM} 4.4.180 ${MODEL} redpill.ko ..."
        sudo curl -k --location --progress-bar "https://$gitdomain/PeterSuh-Q3/redpill-load/raw/master/ext/rp-lkm/redpill-linux-ds1019+-v4.4.180+.ko" --output /home/tc/custom-module/redpill.ko
