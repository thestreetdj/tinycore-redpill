...
if [ $MODEL == "DS1621xs+" ]||[ $MODEL == "RS3618xs" ]; then
    ...
    cecho y "Downloading peter's ${ORIGIN_PLATFORM} 3.10.180 redpill.ko ..."
    sudo curl --location --progress-bar "https://github.com/PeterSuh-Q3/redpill-load/raw/master/ext/rp-lkm/redpill-linux-v3.10.180+.ko" --output /home/tc/custom-module/redpill.ko
