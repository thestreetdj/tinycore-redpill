...
MSGRU18="Соберите загрузчик [TCRP 7.2.1-69057]"
...
MSGFR18="Construisez le chargeur [TCRP 7.2.1-69057]"
...
MSGDE18="Erstellen Sie den [TCRP 7.2.1-69057] Loader"
...
MSGES18="Construir el cargador [TCRP 7.2.1-69057]"
...
MSGBR18="Construa o loader [TCRP 7.2.1-69057]"
...
MSGIT18="Costruisci il caricatore [TCRP 7.2.1-69057]"
...
MSGCN18="构建[TCRP 7.2.1-69057]加载器"
...
MSGJP18="[TCRP 7.2.1-69057]ローダーをビルドする"
...
function setSuggest() {
  ...
  case $1 in
    ...
    DS918+)      platform="apollolake";bay="TOWER_4_Bay";mcpu="Intel Celeron J3455";eval "desc=\"[${MODEL}]:${platform},${bay},${mcpu}, \${MSG${tz}17}, \${MSG${tz}18}\"";;    
