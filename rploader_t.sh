...
#        sudo tar xvfz /home/tc/custom.temp/exts/all-modules/sbin.tgz -C /home/tc/custom.temp
    ...
    sudo curl -kL# https://raw.githubusercontent.com/PeterSuh-Q3/tcrpfriend/main/buildroot/board/tcrpfriend/rootfs-overlay/root/rc.local -o /home/tc/rd.temp/etc/rc.local
    sudo chmod +x /home/tc/rd.temp/etc/rc.local
