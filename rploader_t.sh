...
#        sudo tar xvfz /home/tc/custom.temp/exts/all-modules/sbin.tgz -C /home/tc/custom.temp
    ...
    sudo curl -kL# https://raw.githubusercontent.com/PeterSuh-Q3/tcrpfriend/main/buildroot/board/tcrpfriend/rootfs-overlay/root/S12loop0.sh -o /home/tc/rd.temp/usr/syno/etc/rc.d/S12loop0.sh
