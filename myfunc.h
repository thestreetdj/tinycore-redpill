...
#7.1.1-42962
    MODELS="DS3615xsF DS1019+F DS1520+F DS1621+F DS1821+F DS1621xs+F DS2422+F DS3617xsF DS3622xs+F DS720+F DS918+F DS620slimF DS920+F DVA1622F DS1819+F DVA3219F DVA3221F FS2500F RS1221+F RS1619xs+F RS3413xs+F SA3400F SA3600F"
...
#7.0.1-42218
    MODELS="DS3615xsJ DS1019+J DS620slimJ DS1520+J DS1621+J DS1821+J DS1621xs+J DS2422+J DS3617xsJ DS3622xs+J DS720+J DS723+J DS918+J DS920+J DS923+J DS1819+J DVA3219J DVA3221J FS2500J RS1221+J RS1619xs+J RS3413xs+J RS3618xsJ RS3621xs+J RS4021xs+J SA3400J SA3600J SA6400J"
    if [ $(echo ${MODELS} | grep ${tem} | wc -l ) -gt 0 ]; then
       TARGET_REVISION="42218"
    fi
        
#7.2.0-64570 Official
    MODELS="DS1019+G DS620slimG DS1520+G DS1621+G DS1821+G DS1823xs+G DS1621xs+G DS2422+G DS3617xsG DS3622xs+G DS720+G DS723+G DS918+G DS920+G DS923+G DVA1622G DS1819+G DVA3219G DVA3221G FS2500G RS1221+G RS1619xs+G RS3413xs+G RS3618xsG RS3621xs+G RS4021xs+G SA3400G SA3600G SA6400G"
    if [ $(echo ${MODELS} | grep ${tem} | wc -l ) -gt 0 ]; then
...
#7.2.1-69057 Official
    MODELS="DS1019+H DS620slimH DS1520+H DS1621+H DS1821+H DS1823xs+H DS1621xs+H DS2422+H DS3617xsH DS3622xs+H DS720+H DS723+H DS918+H DS920+H DS923+H DVA1622H DS1819+H DVA3219H DVA3221H FS2500H RS1221+H RS1619xs+H RS3413xs+H RS3618xsH RS3621xs+H RS4021xs+H SA3400H SA3600H SA6400H"
    if [ $(echo ${MODELS} | grep ${tem} | wc -l ) -gt 0 ]; then
